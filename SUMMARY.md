...
* [Intent-Centric framework](architecture/intent-centric-framework/README.md)
  ...
  * [Solvers](architecture/intent-centric-framework/solvers/README.md)
    * [Advanced Optimization Algorithms](architecture/intent-centric-framework/solvers/advanced-optimization-algorithms.md)
    * [Role of Searchers & Resolvers](architecture/intent-centric-framework/solvers/role-of-searchers-and-resolvers.md)
    * [Computational Complexity & Real-Time Data Integration](architecture/intent-centric-framework/solvers/computational-complexity-and-real-time-data-integration.md)
  * [MEV (Maximal Extractable Value)](architecture/intent-centric-framework/mev-maximal-extractable-value/README.md)
    * [Advanced Strategies for Mitigating MEV](architecture/intent-centric-framework/mev-maximal-extractable-value/advanced-strategies-for-mitigating-mev.md)
...
* [Order Flow](architecture/order-flow.md)
